...
/*
    Description: This function delays the program execution for a certain amount of time.
*/
void sleepDelay () {
    #if defined(_WIN32)
        Sleep(1000);
...
/*
    Description: This function waits for the user to press any key to continue.
*/
void displayKey () {
